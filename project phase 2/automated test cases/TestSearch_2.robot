...
Test search function with a keyword 'banana'
# No banana, it should show container for no result scenario with text 'No Result' inside
    Input Text    ${search_bar}    ${search_keyword_banana}
